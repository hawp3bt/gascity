...
export interface components {
    schemas: {
        ...
        EmergencyEventPayload: {
            /** @description Actor that emitted the emergency. */
            actor: string;
            /**
             * Format: date-time
             * @description UTC timestamp when the emergency record was created.
             */
            created_at: string;
            /** @description Hostname that emitted the emergency. */
            hostname?: string;
            /** @description Emergency spool record id. */
            id: string;
            /** @description Human-readable emergency message. */
            message: string;
            /** @description Additional string metadata supplied by the emitter. */
            metadata?: {
                [key: string]: string;
            };
            ...
            /** @description Working directory or source path that emitted the emergency. */
            source_path?: string;
            /**
             * Format: int64
             * @description Process id that emitted the emergency.
             */
            source_pid?: number;
        };
        ErrorDetail: {
        ...
        TypedEventStreamEnvelopeEmergencyAcked: {
            actor: string;
            message?: string;
            payload: components["schemas"]["EmergencyEventPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
