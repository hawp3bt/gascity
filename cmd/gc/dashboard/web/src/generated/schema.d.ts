...
export interface components {
    schemas: {
        ...
        SessionMetadataRepairedPayload: {
            bead_id: string;
        ...
        TypedEventStreamEnvelopeSessionMetadataRepaired: {
            actor: string;
            message?: string;
            payload: components["schemas"]["SessionMetadataRepairedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
